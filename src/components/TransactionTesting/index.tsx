...
const EachTransaction = (props: PropsValues) => {
  ...
  return (
    ...
    >
      {isUserAdmin && (
        <AdminContainer className="flex items-center w-[30vw] md:w-[17.5vw] text-blue-900 font-inter text-lg font-medium">
      ...
      <UserContainer isAdmin={isUserAdmin} className="flex items-center w-[30vw] md:w-[20.5vw]">
        {!isUserAdmin && (
          <>
            {eachTransaction.type === "credit" ? (
              <CreditDebitImage
